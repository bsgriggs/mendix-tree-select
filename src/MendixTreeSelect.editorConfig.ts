...
// export function check(_values: TreeSelectPreviewProps): Problem[] {
...
// export function getPreview(values: TreeSelectPreviewProps, isDarkMode: boolean): PreviewProps {
...
// export function getCustomCaption(values: TreeSelectPreviewProps, platform: Platform): string {
//     return "TreeSelect";
// }
